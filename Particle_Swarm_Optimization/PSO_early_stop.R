...
particleSwarm <- function(n, numberOfIterations = 100, decrement_factor = 0.975, inertia_weight = 0.9, wait_interval = 20) {
  ...
  for (t in 1:numberOfIterations) {
    ...
    } else if (global_best_particle_params[n + 2] <= t - wait_interval) {
